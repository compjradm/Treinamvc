...
CREATE TABLE IF NOT EXISTS sakila.actor (
  actor_id SMALLINT  NOT NULL UNIQUE DEFAULT nextval('actor_id_seq'),
  first_name VARCHAR(45) NOT NULL,
  last_name VARCHAR(45) NOT NULL,
  last_update TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (actor_id));
  CREATE INDEX idx_actor_last_name on sakila.actor (last_name) ;
ALTER SEQUENCE actor_id_seq OWNED BY sakila.actor.actor_id;

-- /* pode ser utilizado o tipo SERIAL como sequenciador */
...
CREATE TABLE IF NOT EXISTS sakila.country (
  country_id SMALLINT  NOT NULL UNIQUE DEFAULT nextval('country_id_seq'),
  country VARCHAR(50) NOT NULL,
  last_update TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (country_id));
  ALTER SEQUENCE country_id_seq OWNED BY sakila.country.country_id;
...
-- -----------------------------------------------------
  ...
  city_id SMALLINT  NOT NULL UNIQUE DEFAULT nextval('city_id_seq'),
...
ALTER SEQUENCE city_id_seq OWNED BY sakila.city.city_id;
...
CREATE TABLE IF NOT EXISTS sakila.address (
  address_id SMALLINT  NOT NULL UNIQUE DEFAULT nextval('address_id_seq'),
  ...
  CONSTRAINT fk_address_city
    ...
    ALTER SEQUENCE city_id_seq OWNED BY sakila.address.address_id;
...
CREATE TABLE IF NOT EXISTS sakila.category (
  category_id TINYINT  NOT NULL UNIQUE DEFAULT nextval('category_id_seq'),
  name VARCHAR(25) NOT NULL,
  last_update TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (category_id));
  ALTER SEQUENCE category_id_seq OWNED BY sakila.category.category_id;
...
CREATE TABLE IF NOT EXISTS sakila.staff (
  staff_id TINYINT  NOT NULL UNIQUE DEFAULT nextval('staff_id_seq'),
  first_name VARCHAR(45) NOT NULL,
  last_name VARCHAR(45) NOT NULL,
...
CREATE TABLE IF NOT EXISTS sakila.language (
  language_id TINYINT  NOT NULL UNIQUE,
...
CREATE TABLE IF NOT EXISTS sakila.inventory (
  inventory_id MEDIUMINT  NOT NULL UNIQUE,
  film_id SMALLINT  NOT NULL,
  store_id TINYINT  NOT NULL,
  last_update TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
